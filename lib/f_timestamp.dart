...
class FTimestamp implements Comparable<FTimestamp> {
  ...
  factory FTimestamp.fromMillisecondsSinceEpoch(int milliseconds) {
    ...
    return FTimestamp(seconds, nanoseconds);
  }

  /// Create a [FTimestamp] fromMicrosecondsSinceEpoch
  ...
  /// Create a [FTimestamp] from [DateTime] instance
  factory FTimestamp.fromDate(DateTime date) {
    return FTimestamp.fromMicrosecondsSinceEpoch(date.microsecondsSinceEpoch);
  }

  /// Create a [FTimestamp] from [DateTime].now()
  factory FTimestamp.now() {
    return FTimestamp.fromMicrosecondsSinceEpoch(
  ...
  /// Converts [FTimestamp] to [DateTime]
  DateTime toDate() {
